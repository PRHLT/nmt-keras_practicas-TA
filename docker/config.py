def load_parameters():
    ...
    DATA_ROOT_PATH = '/data/Data/%s/' % (DATASET_NAME)  # Path where data is stored.
    ...
    STORE_PATH = '/data/trained_models/' + MODEL_NAME + '/'  # Models and evaluation results will be stored here.
    DATASET_STORE_PATH = '/data/datasets/'                   # Dataset instance will be stored here.
